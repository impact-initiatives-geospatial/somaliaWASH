...
leaflet() %>% 
  ...
  leafgl::addGlPolygons(data = df_som_data_polygons, fillColor = ~pal(mainsource_water_borehole), group = "mainsource_water_borehole") |> 
  ...
  addLayersControl(
    ...
    overlayGroups = c("mainsource_water_borehole", "water_source_type"),
...
leaflet() %>% 
  ...
  addProviderTiles(providers$Esri.WorldImagery, 
                   ...
                   group="Esri World Imagery") |>
  setView(lng = 43.825611, lat= 2.766313, zoom = 8) %>%
  leafgl::addGlPolygons(data = df_som_data_polygons, fillColor = ~pal(mainsource_water_well_unprotected), group = "mainsource_water_well_unprotected") |> 
  ...
  addLayersControl(
    baseGroups = c("Esri Gray Canvas", "Here SatelliteDay", "Esri World Imagery"),
    overlayGroups = c("mainsource_water_well_unprotected", "water_source_type"),
    options = layersControlOptions(collapsed = FALSE)
  )
...
###########################################################################3
# Reported mainsource_water_kiosk as main source
##############################################################################
leaflet() %>% 
  addProviderTiles(providers$Esri.WorldGrayCanvas, 
                   options = providerTileOptions(minZoom = 3.75, maxZoom = 10.5), 
  ...
  addProviderTiles(providers$Esri.WorldImagery, 
                   ...
                   group="Esri World Imagery") |>
  setView(lng = 43.825611, lat= 2.766313, zoom = 8) %>%
  leafgl::addGlPolygons(data = df_som_data_polygons, fillColor = ~pal(mainsource_water_kiosk), group = "mainsource_water_kiosk") |> 
  ...
  addLayersControl(
    baseGroups = c("Esri Gray Canvas", "Here SatelliteDay", "Esri World Imagery"),
    overlayGroups = c("mainsource_water_kiosk", "water_source_type"),
    options = layersControlOptions(collapsed = FALSE)
  )
...
###########################################################################3
# Reported mainsource_water_publictap as main source
##############################################################################
leaflet() %>% 
  addProviderTiles(providers$Esri.WorldGrayCanvas, 
                   options = providerTileOptions(minZoom = 3.75, maxZoom = 10.5), 
  ...
  addProviderTiles(providers$Esri.WorldImagery, 
                   ...
                   group="Esri World Imagery") |>
  setView(lng = 43.825611, lat= 2.766313, zoom = 8) %>%
  leafgl::addGlPolygons(data = df_som_data_polygons, fillColor = ~pal(mainsource_water_publictap), group = "mainsource_water_publictap") |> 
  ...
  addLayersControl(
    baseGroups = c("Esri Gray Canvas", "Here SatelliteDay", "Esri World Imagery"),
    overlayGroups = c("mainsource_water_publictap", "water_source_type"),
    options = layersControlOptions(collapsed = FALSE)
  )
...
###########################################################################3
# Reported mainsource_water_spring_unprotected as main source
##############################################################################
leaflet() %>% 
  addProviderTiles(providers$Esri.WorldGrayCanvas, 
                   options = providerTileOptions(minZoom = 3.75, maxZoom = 10.5), 
  ...
  addProviderTiles(providers$Esri.WorldImagery, 
                   ...
                   group="Esri World Imagery") |>
  setView(lng = 43.825611, lat= 2.766313, zoom = 8) %>%
  leafgl::addGlPolygons(data = df_som_data_polygons, fillColor = ~pal(mainsource_water_spring_unprotected), group = "mainsource_water_spring_unprotected") |> 
  ...
  addLayersControl(
    baseGroups = c("Esri Gray Canvas", "Here SatelliteDay", "Esri World Imagery"),
    overlayGroups = c("mainsource_water_spring_unprotected", "water_source_type"),
    options = layersControlOptions(collapsed = FALSE)
  )
